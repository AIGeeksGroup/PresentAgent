...
if __name__ == '__main__':
    ...
    wav_path, input_text, out_path, time_step, p_w, t_w, file_name = args.input_wav, args.input_text, args.output_dir, args.time_step, args.p_w, args.t_w, args.output_file_name
    ...
    save_wav(wav_bytes, f'{out_path}/{file_name}.wav')